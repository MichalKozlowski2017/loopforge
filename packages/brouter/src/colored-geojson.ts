 ...
 * becomes a segment, so the line always follows the polyline.
 * Do not omit long edges here: that dashed the rural map. Geometry safety
 * belongs in prune / candidate selection, not in map painting.
 */
